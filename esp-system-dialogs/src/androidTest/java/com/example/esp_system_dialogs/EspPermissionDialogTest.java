...
public class EspPermissionDialogTest extends EspressoTestCase<BaseActivity> {
    ...
    private void assertTestPermissionIsGranted() {
        Assert.assertThat(EspPermissionsTool.isPermissionGranted(testPermission), CoreMatchers.is(true));
    }

    private void assertTestPermissionIsDenied() {
        Assert.assertThat(EspPermissionsTool.isPermissionGranted(testPermission), CoreMatchers.is(false));
    }
}