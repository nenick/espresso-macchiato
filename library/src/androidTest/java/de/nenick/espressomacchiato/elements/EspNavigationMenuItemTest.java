...
public class EspNavigationMenuItemTest extends EspressoTestCase<NavigationDrawerActivity> {
    ...
    public void testClickFailureWhenInvisible() {
        ...
        exception.expectMessage("No views in hierarchy found matching: ((an instance of android.support.design.internal.NavigationMenuItemView and has child: with text: is \"standard navigation item\") and is displayed on the screen to the user)");
