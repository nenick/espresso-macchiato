...
public class EspRecyclerViewLayoutManager {
    ...
    public void assertLinearLayoutManager() {
        recyclerViewInteraction.check(LayoutManagerTypeAssertion.isLinearLayoutManager());
    }
    ...
    public void assertGridLayoutManager() {
        recyclerViewInteraction.check(LayoutManagerTypeAssertion.isGridLayoutManager());
    }
