...
public class EspRecyclerViewItem {
    ...
    public void assertNotExist() {
        Espresso.onView(EspRecyclerViewMatcher.withRecyclerView(recyclerViewMatcher)
    ...
    protected ViewInteraction findRecyclerView() {
        return Espresso.onView(baseMatcher());
    }
    ...
    protected ViewInteraction findRecyclerView(Matcher<View> additional) {
        return Espresso.onView(allOf(baseMatcher(), additional));
    }
    ...
    protected ViewInteraction findView(List<Matcher<View>> additional) {
        ...
        return Espresso.onView(CoreMatchers.allOf(allMatcher));
    }
}
