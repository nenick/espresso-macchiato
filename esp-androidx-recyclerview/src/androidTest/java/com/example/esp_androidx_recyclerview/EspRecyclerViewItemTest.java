...
public class EspRecyclerViewItemTest extends EspressoTestCase<LongRecyclerActivity> {
    ...
    private final Matcher<View> recyclerViewMatcher = ViewMatchers.withId(LongRecyclerActivity.recyclerViewId);
    ...
    public void testBaseMatcherForItemChild() {
        EspTextView espTextView = new EspTextView(itemInitialDisplayed.baseMatcherForItemChild(ViewMatchers.withId(LongRecyclerActivity.itemTextViewId)));
        espTextView.assertTextIs("item: 0");
    }

    @Test
    public void testBaseMatcherForItemChildFailureWhenItemIsNotDisplayed() {
        EspTextView espTextView = new EspTextView(itemInitialNotDisplayed.baseMatcherForItemChild(ViewMatchers.withId(LongRecyclerActivity.itemTextViewId)));
